> **历史规格，已被替代。** 当前行为基线是 [2026-08-13 可扩展资产扫描器设计](./2026-08-13-extensible-asset-scanner-design.md)。本文中的固定模块编排、`watch`、固定周期、协议 1.0 单文件 Snapshot 和具体下游设想不再是当前实现目标，仅供追溯早期决策。

# Linux 资产采集 Agent 设计规格

日期：2026-08-12  
状态：设计与书面规格已批准，开始分阶段实施
